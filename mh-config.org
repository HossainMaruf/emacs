...
#+begin_src emacs-lisp
  (when (display-graphic-p)
    ...
    (defun display-startup-echo-area-message () (message "Hey, Welcome To Code"))
    ...
    ; t -> always scroll
    ; 'first-error -> stop on first error
    ; nil -> no scroll
    (setq display-line-numbers-type 'relative
          doc-view-continuous t
          indo-enable-flex-matching t
          ido-everywhere t
          visible-bell 1
...
* TRANSPARENCY
With Emacs version 29, true transparency has been added.  I have turned transparency off by setting the alpha to '100'.  If you want some slight transparency, try setting alpha to '90'.
Of course, if you set alpha to '0', the background of Emacs would completely transparent.
